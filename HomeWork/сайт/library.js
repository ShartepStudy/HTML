...
function text_3d(text, x, y, tcolor, fsize, xid, fweight, ffamily, zind){
	...
	var xstr = '<div ID=' + xid +'_1 STYLE="position: absolute; top:' + (y + sd) + '; left: ' + (x + sd) + xzind + '; ' + xstyle + ' color: gray">' + text + '</div>'

	xstr += '<div ID=' + xid +'_2 STYLE="position: absolute; top:' + y + '; left: ' + x + xzind + '; ' + xstyle + ' color: silver">' + text + '</div>'

	xstr += '<div ID=' + xid +'_3 STYLE="position: absolute; top:' + (y + hd) + '; left: ' + (x + hd) + xzind + '; ' + xstyle + ' color:'  + tcolor + '">' + text + '</div>'
...
function paint_top() {
	...
	tmp = -1
	tmp = navigator.userAgent.indexOf('Firefox')
	if (tmp != -1) navigator_name = 'Netscape'
	...
	if (screen.width >= 1280) {
		...
		xstr += '<a HREF="main_news.html" STYLE="position:absolute; top:116px; left:' + (w_weight - 35).toString() + '"><img ID="tr_rus" SRC="pic/tr_rus' + scr_size + '.gif" BORDER="0" ALT="Русский" onMouseOver="tr_mouse_move('+kv+'tr_rus'+kv+', '+kv+'_over'+kv+')" onMouseOut="tr_mouse_move('+kv+'tr_rus'+kv+','+kv+kv+')" onMouseDown="tr_mouse_move('+kv+'tr_rus'+kv+', '+kv+'_down'+kv+')"></a>'
		xstr += '<a HREF="main_news_eng.html" STYLE="position:absolute; top:116px; left:' + (w_weight - 70).toString() + '"><img ID="tr_eng" SRC="pic/tr_eng' + scr_size + '.gif" BORDER="0" ALT="English" onMouseOver="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+'_over'+kv+')" onMouseOut="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+kv+')" onMouseDown="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+'_down'+kv+')"></a>'
		
		xstr += '<form METHOD=get ACTION="yandex_search.php">'
		xstr += 	'<input TYPE="hidden" NAME="enc" VALUE="windows-1251">'
		if (navigator_name != "Opera") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="32" STYLE="position:absolute; font-size:11px; background:#a9aba8; top:117px; left:' + (w_weight - 290).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
		else {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="28" STYLE="position:absolute; font-size:11px; background:#a9aba8; top:117px; left:' + (w_weight - 290).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }

   		xstr += 	'<input TYPE="submit" ID="tr_find" VALUE="" CLASS="submit_class_1280_1024" STYLE="top:117px; left:' + (w_weight - 103).toString() + '">'
		xstr += '</form>'
	...
	if (screen.width >= 1024 & screen.width < 1280) {
		...
		xstr += '<a HREF="main_news.html" STYLE="position:absolute; top:82px; left:' + (w_weight - 30).toString() + '"><img ID="tr_rus" SRC="pic/tr_rus' + scr_size + '.gif" BORDER="0" ALT="Русский" onMouseOver="tr_mouse_move('+kv+'tr_rus'+kv+', '+kv+'_over'+kv+')" onMouseOut="tr_mouse_move('+kv+'tr_rus'+kv+','+kv+kv+')" onMouseDown="tr_mouse_move('+kv+'tr_rus'+kv+', '+kv+'_down'+kv+')"></a>'
		xstr += '<a HREF="main_news_eng.html" STYLE="position:absolute; top:82px; left:' + (w_weight - 60).toString() + '"><img ID="tr_eng" SRC="pic/tr_eng' + scr_size + '.gif" BORDER="0" ALT="English" onMouseOver="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+'_over'+kv+')" onMouseOut="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+kv+')" onMouseDown="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+'_down'+kv+')"></a>'

		xstr += '<form METHOD=get ACTION="yandex_search.php">'
		xstr += 	'<input TYPE="hidden" NAME="enc" VALUE="windows-1251">'
		if (navigator_name == "Opera") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="22" STYLE="position:absolute; font-size:9px; background:#a9aba8; top:81px; left:' + (w_weight - 210).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
		if (navigator_name == "Netscape") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="26" STYLE="position:absolute; font-size:9px; background:#a9aba8; top:81px; left:' + (w_weight - 210).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
		if (navigator_name == "Explorer") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="20" STYLE="position:absolute; font-size:9px; background:#a9aba8; top:81px; left:' + (w_weight - 210).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
   		xstr += 	'<input TYPE="submit" ID="tr_find" VALUE="" CLASS="submit_class_1024_768" STYLE="top:82px; left:' + (w_weight - 85).toString() + '">'
		xstr += '</form>'
	...
	if (screen.width < 1024) {
		...
		xstr += '<a HREF="main_news.html" STYLE="position:absolute; top:74px; left:' + (w_weight - 27).toString() + '"><img ID="tr_rus" SRC="pic/tr_rus' + scr_size + '.gif" BORDER="0" ALT="Русский" onMouseOver="tr_mouse_move('+kv+'tr_rus'+kv+', '+kv+'_over'+kv+')" onMouseOut="tr_mouse_move('+kv+'tr_rus'+kv+','+kv+kv+')" onMouseDown="tr_mouse_move('+kv+'tr_rus'+kv+', '+kv+'_down'+kv+')"></a>'
		xstr += '<a HREF="main_news_eng.html" STYLE="position:absolute; top:74px; left:' + (w_weight - 54).toString() + '"><img ID="tr_eng" SRC="pic/tr_eng' + scr_size + '.gif" BORDER="0" ALT="English" onMouseOver="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+'_over'+kv+')" onMouseOut="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+kv+')" onMouseDown="tr_mouse_move('+kv+'tr_eng'+kv+', '+kv+'_down'+kv+')"></a>'

		xstr += '<form METHOD=get ACTION="yandex_search.php">'
		xstr += 	'<input TYPE="hidden" NAME="enc" VALUE="windows-1251">'
		if (navigator_name == "Opera") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="22" STYLE="position:absolute; font-size:6px; background:#a9aba8; top:71px; left:' + (w_weight - 195).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
		if (navigator_name == "Netscape") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="27" STYLE="position:absolute; font-size:8px; background:#a9aba8; top:73px; left:' + (w_weight - 195).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
		if (navigator_name == "Explorer") {
	   		xstr +=	'<input TYPE="text" NAME="q" ID="tr_find_form" DIR="ltr" LANG="ru" VALUE="поиск по сайту" SIZE="26" STYLE="position:absolute; font-size:8px; background:#a9aba8; top:73px; left:' + (w_weight - 195).toString() + 'px" onMouseOver="tr_find_form_over()" onMouseOut="tr_find_form_out()" onFocus="tr_find_form_focus()">' }
   		xstr += 	'<input TYPE="submit" ID="tr_find" VALUE="" CLASS="submit_class_800_600" STYLE="top:74px; left:' + (w_weight - 70).toString() + '">'
		xstr += '</form>'
